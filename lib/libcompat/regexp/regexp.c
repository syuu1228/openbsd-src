/*	$OpenBSD: src/lib/libcompat/regexp/regexp.c,v 1.5 2006/04/09 04:58:37 deraadt Exp $	*/
...
#ifndef lint
static char *rcsid = "$OpenBSD: src/lib/libcompat/regexp/regexp.c,v 1.5 2006/04/09 04:58:37 deraadt Exp $";
#endif /* not lint */
