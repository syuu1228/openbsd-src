/*	$OpenBSD: src/lib/libwrap/fix_options.c,v 1.5 2003/04/05 00:49:25 tdeval Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/fix_options.c,v 1.5 2003/04/05 00:49:25 tdeval Exp $";
#endif
#endif
