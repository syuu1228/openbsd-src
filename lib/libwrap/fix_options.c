/*	$OpenBSD: src/lib/libwrap/fix_options.c,v 1.3 2000/10/14 00:56:15 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/fix_options.c,v 1.3 2000/10/14 00:56:15 itojun Exp $";
#endif
#endif
