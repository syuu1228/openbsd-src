/*	$OpenBSD: src/lib/libwrap/fix_options.c,v 1.4 2002/02/24 02:24:37 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/fix_options.c,v 1.4 2002/02/24 02:24:37 deraadt Exp $";
#endif
#endif
