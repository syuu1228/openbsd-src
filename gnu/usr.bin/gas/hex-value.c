/*	$OpenBSD: src/gnu/usr.bin/gas/hex-value.c,v 1.2 1998/02/15 18:48:50 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/hex-value.c,v 1.2 1998/02/15 18:48:50 niklas Exp $";
#endif
