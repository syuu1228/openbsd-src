/*	$OpenBSD: src/gnu/usr.bin/gas/output-file.c,v 1.2 1998/02/15 18:48:57 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/output-file.c,v 1.2 1998/02/15 18:48:57 niklas Exp $";
#endif
