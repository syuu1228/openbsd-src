/*	$OpenBSD: src/gnu/usr.bin/gas/as.c,v 1.4 2002/04/20 01:13:44 deraadt Exp $	*/
 ...
 */
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/as.c,v 1.4 2002/04/20 01:13:44 deraadt Exp $";
#endif
