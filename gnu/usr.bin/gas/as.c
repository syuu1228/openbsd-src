/*	$OpenBSD: src/gnu/usr.bin/gas/as.c,v 1.3 1999/12/07 20:10:32 espie Exp $	*/
 ...
 */
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/as.c,v 1.3 1999/12/07 20:10:32 espie Exp $";
#endif
