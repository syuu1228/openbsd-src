/*	$OpenBSD: src/gnu/usr.bin/gas/input-file.c,v 1.2 1998/02/15 18:48:51 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/input-file.c,v 1.2 1998/02/15 18:48:51 niklas Exp $";
#endif
