/*	$OpenBSD: src/gnu/usr.bin/gas/input-file.c,v 1.3 2001/07/09 07:04:35 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/input-file.c,v 1.3 2001/07/09 07:04:35 deraadt Exp $";
#endif
