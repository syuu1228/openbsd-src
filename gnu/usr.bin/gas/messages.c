/*	$OpenBSD: src/gnu/usr.bin/gas/messages.c,v 1.3 2002/04/20 01:13:57 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/messages.c,v 1.3 2002/04/20 01:13:57 deraadt Exp $";
#endif
