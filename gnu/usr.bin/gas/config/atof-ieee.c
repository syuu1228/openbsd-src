/*	$OpenBSD: src/gnu/usr.bin/gas/config/atof-ieee.c,v 1.3 1998/02/15 18:49:10 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/config/atof-ieee.c,v 1.3 1998/02/15 18:49:10 niklas Exp $";
#endif
