/*	$OpenBSD: src/gnu/usr.bin/gas/config/tc-sparc.c,v 1.2 1996/04/23 00:16:06 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/config/tc-sparc.c,v 1.2 1996/04/23 00:16:06 niklas Exp $";
#endif
