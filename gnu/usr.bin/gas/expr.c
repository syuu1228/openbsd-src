/*	$OpenBSD: src/gnu/usr.bin/gas/expr.c,v 1.4 1998/02/16 06:51:12 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/expr.c,v 1.4 1998/02/16 06:51:12 deraadt Exp $";
#endif
