/*	$OpenBSD: src/gnu/usr.bin/gas/atof-generic.c,v 1.3 1999/06/16 15:19:46 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/atof-generic.c,v 1.3 1999/06/16 15:19:46 deraadt Exp $";
#endif
