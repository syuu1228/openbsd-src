/*	$OpenBSD: src/gnu/usr.bin/gas/atof-generic.c,v 1.4 2002/12/09 00:45:34 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/atof-generic.c,v 1.4 2002/12/09 00:45:34 millert Exp $";
#endif
