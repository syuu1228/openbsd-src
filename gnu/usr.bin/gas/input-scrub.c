/*	$OpenBSD: src/gnu/usr.bin/gas/input-scrub.c,v 1.2 1998/02/15 18:48:53 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/input-scrub.c,v 1.2 1998/02/15 18:48:53 niklas Exp $";
#endif
