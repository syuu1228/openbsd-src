/*	$OpenBSD: src/gnu/usr.bin/gas/hash.c,v 1.4 2003/02/02 02:56:26 miod Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/hash.c,v 1.4 2003/02/02 02:56:26 miod Exp $";
#endif
