/*	$OpenBSD: src/gnu/usr.bin/gas/hash.c,v 1.3 1998/04/25 06:48:37 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/hash.c,v 1.3 1998/04/25 06:48:37 niklas Exp $";
#endif
