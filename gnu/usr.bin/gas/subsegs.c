/*	$OpenBSD: src/gnu/usr.bin/gas/subsegs.c,v 1.2 1998/02/15 18:49:00 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/subsegs.c,v 1.2 1998/02/15 18:49:00 niklas Exp $";
#endif
