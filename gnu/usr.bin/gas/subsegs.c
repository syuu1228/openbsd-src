/*	$OpenBSD: src/gnu/usr.bin/gas/subsegs.c,v 1.3 2002/07/16 19:57:58 fgsch Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/subsegs.c,v 1.3 2002/07/16 19:57:58 fgsch Exp $";
#endif
