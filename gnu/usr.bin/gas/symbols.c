/*	$OpenBSD: src/gnu/usr.bin/gas/symbols.c,v 1.3 1998/02/28 00:52:00 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/symbols.c,v 1.3 1998/02/28 00:52:00 niklas Exp $";
#endif
