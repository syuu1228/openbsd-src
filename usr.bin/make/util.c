/*	$OpenBSD: src/usr.bin/make/util.c,v 1.8 1998/06/03 17:00:04 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.8 1998/06/03 17:00:04 deraadt Exp $";
#endif
