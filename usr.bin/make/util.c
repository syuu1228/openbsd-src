/*	$OpenBSD: src/usr.bin/make/util.c,v 1.3 1996/06/26 05:36:38 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.3 1996/06/26 05:36:38 deraadt Exp $";
#endif
