/*	$OpenBSD: src/usr.bin/make/util.c,v 1.13 2000/09/14 13:32:08 espie Exp $	*/
...
#ifndef lint
UNUSED
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.13 2000/09/14 13:32:08 espie Exp $";
#endif
