/*	$OpenPackages$ */
/*	$OpenBSD: src/usr.bin/make/util.c,v 1.15 2001/05/03 14:06:20 espie Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.15 2001/05/03 14:06:20 espie Exp $";
#endif
