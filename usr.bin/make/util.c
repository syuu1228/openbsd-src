/*	$OpenBSD: src/usr.bin/make/util.c,v 1.5 1996/11/30 21:09:06 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.5 1996/11/30 21:09:06 millert Exp $";
#endif
