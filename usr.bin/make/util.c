/*	$OpenBSD: src/usr.bin/make/util.c,v 1.11 1999/11/11 11:35:17 espie Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.11 1999/11/11 11:35:17 espie Exp $";
#endif
