/*	$OpenBSD: src/usr.bin/make/util.c,v 1.10 1998/12/20 23:38:11 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.10 1998/12/20 23:38:11 deraadt Exp $";
#endif
