/*	$OpenBSD: src/usr.bin/make/util.c,v 1.9 1998/12/05 00:06:29 espie Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.9 1998/12/05 00:06:29 espie Exp $";
#endif
