/*	$OpenBSD: src/usr.bin/make/util.c,v 1.6 1997/04/01 07:28:26 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.6 1997/04/01 07:28:26 millert Exp $";
#endif
