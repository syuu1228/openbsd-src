/*	$OpenBSD: src/usr.bin/make/util.c,v 1.4 1996/09/02 16:04:21 briggs Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.4 1996/09/02 16:04:21 briggs Exp $";
#endif
