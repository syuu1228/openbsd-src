/*	$OpenPackages$ */
/*	$OpenBSD: src/usr.bin/make/util.c,v 1.14 2001/05/03 13:41:12 espie Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.14 2001/05/03 13:41:12 espie Exp $";
#endif
