/*	$OpenBSD: src/usr.bin/make/util.c,v 1.7 1997/07/25 21:05:36 mickey Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.7 1997/07/25 21:05:36 mickey Exp $";
#endif
