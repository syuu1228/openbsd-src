/*	$OpenBSD: src/usr.bin/make/util.c,v 1.12 2000/06/23 16:39:45 espie Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/make/util.c,v 1.12 2000/06/23 16:39:45 espie Exp $";
#endif
